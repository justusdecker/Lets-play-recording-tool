...
class ThumbnailGenerate(TKFrameWithLPControls):
    def __init__(self, parent, controller):
        ...
        check_for_each_option_var = tk.BooleanVar(value=False)
        
        ttk.Label(self.W,text='Options',font=Font(self.W,size=14)).pack()
        
        self.check_for_each_option = ttk.Checkbutton(self.W, text='Check each', variable=check_for_each_option_var)

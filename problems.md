...
Audio export & Audio Fix can be closed before finished. 

This results in a too short audiotrack. 

The user will not notice this problem at first!

Throw an error if the audio lengths & video are not equal!
